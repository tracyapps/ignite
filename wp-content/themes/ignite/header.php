...
<div id="page" class="sticky-container ">
	<a href="#content" class="sr-only"><?php esc_html_e( 'Skip to content', 'ITS' ); ?></a>

	<header class="site_main_header mask-container">
		<div id="ITS_MAIN_LOGO">
				...
				<div class="utility_right_side">
					...
					<label class="darkmode_switch">
						...
						<svg class="switch__icon switch__icon--dark" viewBox="0 0 12 12" width="12px" height="12px" aria-hidden="true">
							<g fill="none" stroke="#171717" stroke-width="1" stroke-linejoin="round" transform="rotate(-45,6,6)">
		...
		<div class="mask-box flex-row header">
